...
export default function App() {
  ...
  async function handleSavedWebDavDownload() {
    ...
    await runWebDavAction(async () => {
      const result = await webdavDownloadRemoteVaultWithSavedConfig(masterPassword, true);
      await reloadVaultRecords();
      return result;
    });
  }
