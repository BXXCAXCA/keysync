...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::vault::vault_export_encrypted_backup,
            commands::vault::vault_import_encrypted_backup,
            commands::vault::vault_export_plaintext_backup,
            commands::vault::vault_import_plaintext_backup,
            ...
            commands::sync::webdav_upload_settings_with_saved_config,
            commands::sync::webdav_download_settings_with_saved_config,
        ])
